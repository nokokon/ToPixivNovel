...
Private Sub getBoldStyle()
    If (pBoldRange) And (Not pChar.Style = "強調太字") Then
        pBoldRange = False
        pLineString = pLineString & "]": Exit Sub
    ElseIf (Not pBoldRange) And (pChar.Style = "強調太字") Then
        pBoldRange = True
        pLineString = pLineString & "[b:": Exit Sub
    End If
End Sub

Private Sub getItalicStyle()
    If (pItalicRange) And (Not pChar.Style = "斜体") Then
        pItalicRange = False
        pLineString = pLineString & "]": Exit Sub
    ElseIf (Not pItalicRange) And (pChar.Style = "斜体") Then
        pItalicRange = True
        pLineString = pLineString & "[i:": Exit Sub
    End If
End Sub

Private Sub getBoldItalicStyle()
    If (pBoldItalicRange) And (Not pChar.Style = "強調太字＋斜体") Then
        pBoldItalicRange = False
        pLineString = pLineString & "]]": Exit Sub
    ElseIf (Not pBoldItalicRange) And (pChar.Style = "強調太字＋斜体") Then
        pBoldItalicRange = True
        pLineString = pLineString & "[b:[i:": Exit Sub
    End If
End Sub
